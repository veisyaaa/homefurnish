...
<head>
    ...
    <title>Beranda - Homefurnish</title>
                        ...
                        <div class="single_banner_slider">
                            ...
                            <div class="row">
                                <div class="col-lg-5 col-md-8">
                                    <div class="banner_text">
                                        <div class="banner_text_iner">
                                            <h1>Sofa Kain & Kayu</h1>
                                            <p>Dibuat dari bahan berkualitas dengan desain modern
                                                pilihan terbaik untuk ruang tamu elegan</p>
                            ...
                            <div class="row">
                                <div class="col-lg-5 col-md-8">
                                    <div class="banner_text">
                                        <div class="banner_text_iner">
                                            <h1>Sofa Simpel Elegan</h1>
                                            <p>Nikmati kenyamanan dan gaya dalam Sofa Simpel Elegan.
                                                Desain elegan yang sempurna untuk ruang tamu Anda.</p>
                                            <a href="Belanja.php" class="btn_2">LIHAT PRODUK</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row align-items-center justify-content-between">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="single_product_item">
                                        <img src="admin/produk_img/<?=
                                        htmlspecialchars($gambar) ?>" alt="<?=
