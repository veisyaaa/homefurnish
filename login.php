                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_text text-center">
                        <div class="login_part_text_iner">
                            <h2>Belum Punya Akun di Homefurnish?</h2>
                            <p>Jelajahi ragam furniture premium untuk empercantik rumah impian anda.
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            <h3>Selamat Datang Kembali! <br> Silahkan Masuk untuk Melanjutkan</h3>
                    ...
                    <div class="col-lg-8">
                        <div class="copyright_text">
                            <P><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                ...
                                </script> All rights reserved | Homefurnish by <a href="https://www.instagram.com/veisyaaa_?igsh=MXMwdWpwNjBydTV0aQ=="
