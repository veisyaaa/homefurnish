                        ...
                        <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                          ...
                          <?php if (isset($_SESSION['username'])) : ?>
                            ...
                            <a href="cart.php" id="cartLink" style="position: relative; display: inline-block;">
                                    ...
                                    <span class="cart-budge"><?= $jumlah_item ?></span>
                                </a>
                        ...
                        <aside class="left_widgets p_filter_widgets">
                            ...
                            <div class="widgets_inner">
                                <ul class="list">
                                    ...
                                    $where_clause = "1=1"; //Default menampilakan semua produk
                                    if (!empty($search)) {
                                        $where_clause .= " AND nm_produk LIKE '%$search%'";
                                    }
                                    if (!empty($id_kategori)) {
                                        $where_clause .= " AND id-kategori = '$id_kategori'"; //Perhatikan tanda kutip untuk string
                                    }
                                    ...
                                    <div class="pagenation">
                                        ...
                                        <li class="page-item">
                                            <a class="page-link" href="?id_kategori=<?php echo $id_kategori; ?>&search=<?php echo $search; ?>&page=<?php echo ($page + 1); ?>" aria-label="Next">
                                                <i class="ti-angle-souble-right"></i>
                                        </a>
                                        </li>
                                    <?php } ?>
                                            </ul>
